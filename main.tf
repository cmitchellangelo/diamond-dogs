...
#   default_action {
#     type             = "forward"
#     target_group_arn = aws_lb_target_group.diamond_dogs.arn  # Add this
#   }
# }
...
#   bucket = aws_s3_bucket.resume_images.id
...
# resource "aws_s3_bucket_policy" "resume_images" {
#   bucket = aws_s3_bucket.resume_images.id
...
#         Principal = "*"
#         Action    = "s3:GetObject"
#         Resource  = "${aws_s3_bucket.resume_images.arn}/*"
#       }
#     ]
#   })
# }
