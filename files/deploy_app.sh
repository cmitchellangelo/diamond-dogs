  ...
  <body>
    <div style="max-width: 800px; margin: 0 auto;">
      ...
      <div class="section">
        ...
        <ul>
          <li>Key Achievement – Spearheaded the inaugural rollout of automated AWS/Azure solutions via catalog items, delivering fully configured environments to fifteen Virginia State (VITA) agencies and eliminating manual deployment processes.</li>
        ...
        <h3>Prometheus Group, Remote (4/2021 – 11/2021)</h3>
        <p><strong>Cloud Operations Engineer</strong></p>
        <ul>
          <li>Key Achievement – Placed on high performance list two quarters in a row for deploying many new customer environments. Bonus and raise my 3rd month on the team.</li>
          ...
          <li>Interfaced with customers, Project Managers, SRE’s to hash out internal/external SAP and/or SSO problems with current builds.</li>
        ...
        <ul>
          <li>Key Achievement – Built the first automated pipeline using Code Commit, AWS Config, and Systems Manager, while managing and guiding the evolution of enterprise cloud-based environments.</li>
        ...
        <h3>Tangoe, Austin Texas (4/2016 – 9/2019)</h3>
        <p><strong>Associate Cloud Engineer (11/2018 – 9/2019)</strong></p>
        <ul>
          <li>Key Achievement – implemented first Infrastructure as Code builds to help streamline application environments.</li>
        ...
        <p><strong>Network Engineer (4/2016 – 11/2018)</strong></p>
        <ul>
          <li>Key Achievement – Major Data Foundry data center VSS upgrade to achieve higher throughput for all network and server systems along with AWS solutions architect – associate certification.</li>
          <li>Research/Training – DevOps/CICD integration from legacy infrastructure using Jenkins, Ansible, & Kubernetes</li>
        ...
        <ul>
          <li>Key Achievement – Built out successful Care20/20 platform for the IRS and SSA to benefit their VOIP solutions.</li>
